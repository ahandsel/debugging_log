...
* All folders and files that are on the Desktop, the consequences of transparency from the Dock to the menu bar is fully managed with WindowServer process.
