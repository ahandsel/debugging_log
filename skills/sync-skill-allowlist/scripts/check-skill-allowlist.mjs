...
// Usage:
//   node skills/sync-skill-allowlist/scripts/check-skill-allowlist.mjs
//   node skills/sync-skill-allowlist/scripts/check-skill-allowlist.mjs --write
//   node skills/sync-skill-allowlist/scripts/check-skill-allowlist.mjs --repo-root /path/to/repo
//
// Output:
