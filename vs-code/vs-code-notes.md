...
* Demo gif:
  * ![vscode-whitespace-setting.gif](../img/vscode-whitespace-setting.gif)
...
1. Install & configure [romkatv/powerlevel10k](https://github.com/romkatv/powerlevel10k)
   * See [mac-setup article's powerlevel10k section](../mac-setup.md#powerlevel10k---a-zsh-theme) for more details.
